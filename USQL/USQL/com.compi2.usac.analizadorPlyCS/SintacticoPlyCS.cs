...
{
    class SintacticoPlyCS: Grammar
    {
        public static bool analizar(String cadena)
        {
            GramaticaPlyCS gramatica = new GramaticaPlyCS();
        ...
        private static void generarImagen(ParseTreeNode raiz)
        {
            ...
            TextWriter file = new StreamWriter("astPlyCS.dot");
            ...
            bat.WriteLine("dot -Tpng astPlyCS.dot -o astPlyCS.png");
            bat.Close();
