...
Module MyParser
    ...
    Public Sub Setup()
        ...
        Parser.LoadTables(Path.Combine(Application.StartupPath, "gramatica.egt"))
    End Sub
        ...
        Do Until Done
            ...
            Select Case Response              
                Case GOLD.ParseMessage.LexicalError
                    ...
                    If Err < 20 Then
                        Dim linea As Integer = Integer.Parse(Parser.CurrentPosition.Line.ToString) + 1
                        Dim columna As Integer = Integer.Parse(Parser.CurrentPosition.Column.ToString) + 1
                        Dim dato As String = Parser.CurrentToken.Data.ToString

                        cadena += Parser.CurrentToken.Data.ToString & ",lexico," & linea & "," & columna & vbCrLf
                        MsgBox("Error Léxico en la fila: " & linea &
                               ". Columna: " & columna &
                               " caracter " & dato)
                ...
                Case GOLD.ParseMessage.SyntaxError
                    ...
                    If Err < 20 Then
                        ...
                        cadena += "Sintactico," & linea & "," & columna & "," & dato & vbCrLf
                        MsgBox("Error Sintáctico en la fila: " & Parser.CurrentPosition.Line.ToString & ". Columna: " & Parser.CurrentPosition.Column.ToString)
                        Parser.DiscardCurrentToken()
                    Else
                        Done = True
                    End If
        ...
        With Reduction
            Select Case .Parent.TableIndex                        
                ...
                Case ProductionIndex.Error_paq_Lbracket_Paquete_Colon_Paq_error_Comma_Tipo_Colon_Comma_Msg_Colon_Cadena_Comma_Datos_Colon_Lbracket_Error_Colon_Cadena_Comma_Instruccion_Colon_Cadena_Comma_Col_Colon_Numero_Comma_Fila_Colon_Numero_Rbracket_Rbracket                 
                    ...
                    Dim temp As Salida = New Salida
                    temp.cadena = .Item(7).Data.ToString & "," &
                                    "," & .Item(11).Data.ToString &
                                    "," & .Item(18).Data.ToString &
                                    "," & .Item(22).Data.ToString &
                                    "," & .Item(26).Data.ToString &
                                    "," & .Item(30).Data.ToString
                    temp.nombre = "error_paq"
                    Result = temp
                ...
                Case ProductionIndex.Usql_rec_Lbracket_Paquete_Colon_Usql_Comma_Datos_Colon_Lbracket_Rbracket_Rbracket                 
                    ...
                    Dim temp As Salida = New Salida
                    temp.cadena = .Item(8).Data.cadena
                    temp.nombre = "usql_rec"
                    Result = temp
                Case ProductionIndex.Lcads_Lbracket_Cadena_Rbracket                 
                    ' <LCADS> ::= <LCADS> '[' cadena ']' 
                    Dim temp As Salida = New Salida
                    temp.cadena = .Item(0).Data.cadena & "," & .Item(2).Data.ToString
                    temp.nombre = "login_rec"
                    Result = temp
                Case ProductionIndex.Lcads_Lbracket_Cadena_Rbracket2                 
                    ' <LCADS> ::= '[' cadena ']' 
                    Dim temp As Salida = New Salida
                    temp.cadena = .Item(1).Data.ToString
                    temp.nombre = "login_rec"
                    Result = temp
                Case ProductionIndex.Login_rec_Lbracket_Validar_Colon_Numero_Comma_Datos_Colon_Cadena_Rbracket                 
                    ...
                    Dim temp As Salida = New Salida
                    temp.cadena = .Item(3).Data.ToString & "," & .Item(7).Data.ToString
                    temp.nombre = "login_rec"
                    Result = temp
            End Select
        End With     
